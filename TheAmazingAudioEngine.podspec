Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/wtanuw/TheAmazingAudioEngine2.git", :tag => "1.0" }
  s.deprecated   = true
  s.ios.deployment_target = '7.0'
  s.osx.deployment_target = '10.9'
  s.tvos.deployment_target = '9.0'
  s.source_files = 'TheAmazingAudioEngine/**/**/*.{h,m,c}'
  s.exclude_files = 'TheAmazingAudioEngine/Modules/Generation/AEAudiobusInputModule*', 'TheAmazingAudioEngine/AERealtimeWatchdog*'
